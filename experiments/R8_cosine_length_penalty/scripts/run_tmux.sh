...
SESSION=tunix
REPO=/home/ext_siqiacademic_gmail_com/tpu-2026
VENV=/home/ext_siqiacademic_gmail_com/venvs/tunix
WANDB_RUN_ID="${WANDB_RUN_ID:-bnh9ttlt}"   # the run that was interrupted
export WANDB_ENTITY="${WANDB_ENTITY:-siqiacademic}"
...
INNER="cd /home/ext_siqiacademic_gmail_com/tpu-2026/scripts && source /home/ext_siqiacademic_gmail_com/venvs/tunix/bin/activate && python -u train.py"
if [[ "${1:-}" == "resume" ]]; then
  INNER="cd /home/ext_siqiacademic_gmail_com/tpu-2026/scripts && source /home/ext_siqiacademic_gmail_com/venvs/tunix/bin/activate && WANDB_RUN_ID=$WANDB_RUN_ID python -u train.py --wandb-run-id $WANDB_RUN_ID"
fi
